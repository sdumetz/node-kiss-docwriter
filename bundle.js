...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function () {
	  var style = new _StyleSet2.default();
	  var renderer = new _MarkdownRenderer2.default(style, document.getElementById("toc"), document.getElementById("content"));
	});
...
/***/ function(module, exports) {
	...
	MarkdownRenderer.prototype.renderToc = function (data) {
	  ...
	  this.toc.appendChild(data.map(function (el) {
	...
	MarkdownRenderer.prototype.hashChanged = function () {
	  ...
	  this.asyncLoad("data/" + hash).then(this.renderMarkup.bind(this)).then(function (rawhtml) {
	    _this2.container.innerHTML = rawhtml;
	...
	function StyleSet(opts) {
	  ...
	  _marked2.default.setOptions({
	    ...
	    highlight: function highlight(code, lang) {
	      if (!lang || !_prismjs2.default.languages[lang]) {
	        lang = 'markup';
	      }
