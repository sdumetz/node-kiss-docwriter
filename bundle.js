...
/***/ function(module, exports) {
	...
	MarkdownRenderer.prototype.renderToc = function (data) {
	  ...
	  this.styleset.toc.appendChild(data.map(function (el) {
	    return _this.makeTocElement(el);
...
/***/ function(module, exports, __webpack_require__) {
	...
	StyleSet.prototype.layout = function () {
	  ...
	  document.getElementById("burger").style.backgroundImage = 'url(\'data:image/svg+xml;base64,' + window.btoa('<svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">\
